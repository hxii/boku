    ...
    def set_verbose(self, verbosity: int) -> None:
        ...
        if verbosity >= 2:
            self.logger.handlers[0].setFormatter(
                self.ColoredFormatter(self.verbose_format, self.color_output)
            )
        if verbosity == 1:
